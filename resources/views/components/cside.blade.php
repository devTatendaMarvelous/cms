        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class=" nav-item"><a href="/"><i class="icon-map"></i><span data-i18n="" class="menu-title">Menus</span></a>
                <ul class="menu-content">
                  
                  
                </ul>
              </li>
              <li class="hub nav-item"><a href="/orders/client"><i class="icon-layers"></i><span data-i18n="" class="menu-title">Your Orders</span></a>
                
              </li>
               <li class="hub nav-item"><a href="/feedbacks/create"><i class="icon-support"></i><span data-i18n="" class="menu-title">Give Us Feedback</span></a>
